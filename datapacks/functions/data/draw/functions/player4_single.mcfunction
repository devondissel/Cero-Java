tp @e[tag=reserve,limit=1,sort=random] 34.75 28 -42 90 0
...
###check for free spot
#first layer
execute as @e[tag=reserve] at @s if entity @e[tag=deck4,distance=..0.01] run tp @s ~ ~ ~1
execute as @e[tag=reserve] at @s if entity @e[tag=deck4,distance=..0.01] run tp @s ~ ~ ~1
execute as @e[tag=reserve] at @s if entity @e[tag=deck4,distance=..0.01] run tp @s ~ ~ ~1
execute as @e[tag=reserve] at @s if entity @e[tag=deck4,distance=..0.01] run tp @s ~ ~ ~1
execute as @e[tag=reserve] at @s if entity @e[tag=deck4,distance=..0.01] run tp @s ~ ~ ~1
...
execute as @e[tag=reserve] at @s if block ~ ~-10 ~ orange_terracotta run tag @s add deck4
tag @e[tag=deck4] remove reserve