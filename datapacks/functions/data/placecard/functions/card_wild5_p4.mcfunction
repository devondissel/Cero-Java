...
execute if score @e[tag=dummy,limit=1] compatible matches 0 run summon minecraft:armor_stand 34.75 26.5 -40 {NoGravity:1b,Invisible:1b,CustomNameVisible:1b,Tags:["select_draw1"],ArmorItems:[{},{},{},{id:"minecraft:lime_concrete",Count:1b}],CustomName:'{"text":"Play","color":"green"}'}
execute if score @e[tag=dummy,limit=1] compatible matches 0 run summon minecraft:armor_stand 34.75 26.5 -38 {NoGravity:1b,Invisible:1b,CustomNameVisible:1b,Tags:["select_draw2"],ArmorItems:[{},{},{},{id:"minecraft:yellow_concrete",Count:1b}],CustomName:'{"text":"Keep","color":"yellow"}'}
