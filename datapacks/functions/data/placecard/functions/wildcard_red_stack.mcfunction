...
tellraw @a ["",{"selector":"@a[tag=turn,limit=1]","color":"aqua"},{"text":" placed down a wild +4 card and changed the color to red. The next player in sequence has to draw ","color":"aqua"},{"score":{"name":"@e[tag=dummy]","objective":"hastodraw2"},"color":"aqua"},{"text":" cards or choose to stack another draw card on top.","color":"aqua"}]
