...
tellraw @a ["",{"selector":"@a[tag=turn,limit=1]","color":"aqua"},{"text":" colocó una carta de +4 y cambió el color a rojo. El siguiente jugador tiene que robar ","color":"aqua"},{"score":{"name":"@e[tag=dummy]","objective":"hastodraw2"},"color":"aqua"},{"text":" cartas o tirar otra carta de robar.","color":"aqua"}]
